...
const CommentSection = () => {
    ...
    const { commentsError, commentsStatus,comment } = useSelector((state) => state.commentSlice);
  ...
  console.log(newComment)
    dispatch(createComment({ userId:userID, videoId:video._id, content:newComment}))
