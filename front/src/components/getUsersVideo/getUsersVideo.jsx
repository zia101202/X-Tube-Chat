              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600">
                    {isExpanded ? video.description : `${video.description.substring(0, 50)}...`}
                    <button 
                      onClick={(e) => {
                  ...
                  <div className="mt-2 flex justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm ml-1">{video.likes}</span>
                    </div>
                    <div className="flex items-center">
                      <ThumbDownAltIcon className="text-blue-500" fontSize="small" />
                      <span className="text-sm ml-1">{video.dislikes}</span>
                    </div>
